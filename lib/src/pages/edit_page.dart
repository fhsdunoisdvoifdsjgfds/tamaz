...
class _EditPageState extends State<EditPage> {
  ...
  void _onCheck() {
    context.read<ButtonsBloc>().add(CheckButton(
          controllers: [
            _controller1.text,
            _controller2.text,
            _controller3.text,
  ...
  void _onEdit() {
    context.read<Modelx>().add(EditModel(
          model: Model(
            id: widget.model.id,
    ...
    showDialog(
      ...
      builder: (context) {
        return DelDialog(
          title: 'Delete?',
          onYes: () {
            context.read<Modelx>().add(DeleteModel(model: widget.model));
            context.pop();
          },
        );
      },
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        BlocBuilder<ButtonsBloc, ButtonState>(
